...
public final class Constants {
    ...
    // minimuim and max speed for settting the rotation speed
    public static double minSpeedRot = .15;
    public static double maxSpeedRot = .5;
...
//Set speed for HomingLift
  public static double setSpeedForLiftHome = -.5;
    ...
    public static final double autonomousMove_P = .2;
    public static final double autonomousRot_P = .01;
