...
public class Auto_Blue9Cone_GrabCube_Climb extends SequentialCommandGroup {
  /** Creates a new Auto_Blue9Cone_GrabCube_Climb. */
  public Auto_Blue9Cone_GrabCube_Climb() {
    ...
    Commands.parallel(new RetrieveCube(), Commands.sequence(new AdvAutoMove(4.5, -.15, 180, .3, .5, .05, 2, false), new AdvAutoMove(4.4, -2.3, 0, .2, .5, .1, 2, false))),
       new GetOnChargeStationFromBack()
    );
  }
}

//May need to replace retrieve cube with autocube pickup
