...
public class Auto_Blue_1Cone_HighCube_LowCone_TEST extends SequentialCommandGroup {
  /** Creates a new Auto_Blue_1Cone_GrabCone_GrabCube. */
  public Auto_Blue_1Cone_HighCube_LowCone_TEST() {
     ...
     Commands.parallel(
      new setGripperPosition(Constants.openGripperPOS),
       Commands.parallel(new setGantryPosition(Constants.gantryPickPOS), 
        ...
        Commands.parallel(new AdvAutoMove(4.9, -.5, 180, .3, .3, .1, 5, false),
        ...
        Commands.parallel(Commands.sequence(new setLiftPosition(Constants.liftAutoCubePOS),
          Commands.parallel(new setGantryPosition(Constants.gantryUpperLevelPOS))),
               ...
               new AdvAutoMove(1, -.4, 0, .3, .6, .1, 5, false),
                      new AdvAutoMove(0.2, -.6, 0, .1, .4, .1, 5, false))),
        new Blank_Command().withTimeout(.5),
        new setGripperPosition(Constants.openGripperPOS),
       Commands.parallel(Commands.parallel(new setGantryPosition(Constants.gantryPickPOS), 
    ...
    new AdvAutoMove(5.1, -1.2, 135, .1, .3, .1, 5, false)
    ...
    // Commands.sequence( new AdvAutoMove(3.5, -.2, 0, .2, .4, .2, 5, false), 
