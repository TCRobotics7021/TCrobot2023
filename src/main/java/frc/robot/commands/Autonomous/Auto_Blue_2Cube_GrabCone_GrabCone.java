    ...
    addCommands(
     ...
     // new CalibrateLiftAtStartOfMatch(850), //change
      ...
      Commands.parallel(
        ...
        Commands.sequence( new AdvAutoMove(2.5, .55, -5, .5, .5, .2, 5, true), new AdvAutoMove(4.3, .25, -175, .4, .4, .1, 5, false))),
        ...
        Commands.parallel(Commands.sequence(new setLiftPosition(Constants.liftLowerLevelPOS), new setArmPosition(Constants.armAutoLowerLevelPOS)),
               Commands.sequence( new AdvAutoMove(2.5, .5, -5, .5, .5, .2, 5, false), 
                      new AdvAutoMove(0.2, .2, 0, .2, .4, .1, 5, false))),
        new setGripperPosition(Constants.openGripperPOS),
       Commands.parallel(new setArmPosition(Constants.armPickPOS), 
              Commands.sequence( new AdvAutoMove(2.5, .55, 0, .5, .5, .2, 5, false), 
              new AdvAutoMove(4.2, 0, 130, .4, .4, .1, 5, false))),
      Commands.parallel(new setLiftPosition(Constants.liftBottomPOS), new AdvAutoMove(4.8, -.9, 135, .2, .3, .1, 5, false)),
    new setGripperPosition(Constants.gripperConeGrabPOS).withTimeout(Constants.gripperTimeout),
    Commands.parallel(Commands.sequence(new setLiftPosition(Constants.liftLowerLevelPOS), new setArmPosition(Constants.armAutoLowerLevelPOS)),
    Commands.sequence( new AdvAutoMove(3, .1, 0, .5, .5, .2, 5, false), 
           new AdvAutoMove(0.1, .1, -5, .2, .4, .1, 5, false))),
    new setGripperPosition(Constants.openGripperPOS)
