...
public class Auto_Red_2Cube_GrabCone_GrabCone extends SequentialCommandGroup {
  /** Creates a new Auto_Blue_2Cube_GrabCube_GrabCube. */
  public Auto_Red_2Cube_GrabCone_GrabCone() {
    ...
    addCommands(
     ...
     // new CalibrateLiftAtStartOfMatch(850), //change
      ...
      Commands.parallel(
        ...
        Commands.sequence( new AdvAutoMove(3.1, .3, 0, .5, .5, .2, 5, true), new AdvAutoMove(4.3, -0.1, 175, .1, .3, .1, 5, false))),
        new AdvAutoMove(4.8, -0.1, 180, .3, .3, .1, 5, false),
        ...
        Commands.parallel(Commands.sequence(new setLiftPosition(Constants.liftLowerLevelPOS), new setArmPosition(Constants.armAutoLowerLevelPOS)),
               Commands.sequence( new AdvAutoMove(4.3, .05, 0, .2, .4, .2, 5, false), 
                      new AdvAutoMove(.1, -0.075, 0, .2, .5, .1, 5, false))),
        new setGripperPosition(Constants.openGripperPOS),
      ...
      Commands.parallel(new setLiftPosition(Constants.liftBottomPOS), new AdvAutoMove(5, -.95, 135, .2, .3, .1, 5, false)),
    new setGripperPosition(Constants.gripperConeGrabPOS).withTimeout(Constants.gripperTimeout),
    Commands.parallel(Commands.sequence(new setLiftPosition(Constants.liftLowerLevelPOS), new setArmPosition(Constants.armAutoLowerLevelPOS)),
    Commands.sequence( new AdvAutoMove(3.5, .1, 0, .1, .3, .2, 5, false), 
           new AdvAutoMove(0, -0.05, 0, .2, .5, .1, 5, false))),
    new setGripperPosition(Constants.openGripperPOS),
    new AdvAutoMove(3, -0.1, -5, .2, .4, .2, .5, false)
