...
public class Auto_Red_9Cone_HighCube_LowCone_TEST extends SequentialCommandGroup {
  /** Creates a new Auto_Blue_1Cone_GrabCone_GrabCube. */
  public Auto_Red_9Cone_HighCube_LowCone_TEST() {
    ...
    // Commands.sequence( new AdvAutoMove(3.5, .4, 0, .2, .4, .2, 5, false), 
